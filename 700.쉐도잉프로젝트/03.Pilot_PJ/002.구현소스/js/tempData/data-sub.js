...
const subData = {
    ...
    <!--
        class="cont c1 카테고리명" -> 해당 배경이미지가 나오도록 카테고리명 클래스 넣기
    ...
    // 컨텐츠영역2 : special
    cont2: `
    <section v-bind:class="'cont c2 '+$store.state.cat" id="c2">
        <h2 class="c2tit js-reveal">2023 SPECIAL {{$store.state.menu[1]}}</h2>
    </section>
    `,
    // 컨텐츠영역3 : 일반소개
    cont3: `
    <section class="cont c3" id="c3">
        <ul class="pgc">
            ...
            <li class="imgc">
                <img  class="js-reveal" :src="'./images/sub/'+$store.state.cat+'/03.disc.png'" alt="해변공유">
            </li>
        </ul>
    </section>
    `,
        ...
        <section class="cont c4" id="c4">
            <ul class="pgc">
                ...
                <li class="txtc">
                    <h2 class="tm">
                        <a href="#" class="js-reveal">
                            {{$store.state.cat.toUpperCase()}}'S<br>{{$store.state.menu[3]}}
                        </a>
                    </h2>
                    <h2 class="tw">
                        <a href="#" class="js-reveal">
            ...
            <div id="imbx">
                <div class="inx">
                    ...
                    <section class="gimg">
                        ...
                        <div class="small">
                            <a href="#">
                            <img v-for="v in 6" :src="'images/goods/'+$store.state.cat+'/m'+v+'.png'" alt="썸네일이미지">
                            </a>
                        </div>
                    </section>
                    <!-- 이미지 설명 -->
