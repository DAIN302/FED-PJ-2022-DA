...
/*
   [ 배너함수 다중배너 세팅함수로 모듈화하기 ]
     -> 전달값을 사용하여 개별적인 배녀오소 하위의 기능으로 작동하도록
        최상위 배열요소를 함수로 전달하여 내부 기능 세팅시
        document로 선택했던 요소를 모두 개별 최상위 배너요소 하위요소
        선택으로 변경하면 기존 변수세팅은 그대로 사용하여 개별 배너
        모듈화를 할 수 있음
   [ 모듈화 원칙 ]
     1. 상대적인 선택자 사용
     2. for문에 의한 개별요소별 일괄 세팅
     3. 구체적인 차이점은 전달변수를 통해 해결     
*/ 
